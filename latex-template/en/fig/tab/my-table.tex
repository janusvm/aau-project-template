...
% ------------------------------------------------------------------------------
% This file contains all the code involved in inputting a single table.  While
% this code can just as well be inserted directly into the documents with the
% body text, I like to keep my projects as modular as possible.
