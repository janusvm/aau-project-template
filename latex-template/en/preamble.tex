...
\usepackage[T1]{fontenc}     % font encoding, adds support for printing accented characters
\usepackage[utf8]{inputenc}  % input incoding, adds support for inputting accented characters
...
% Font packages ------------------------------------------------------------------------------------
% With pdflatex, fonts are limited to those provided in packages (as opposed to xelatex or lualatex,
% which can use system fonts).  The typeface is changed by simply importing the package for it.
%
% See
% * http://www.tug.org/pracjourn/2006-1/hartke/hartke.pdf for a handy list of typefaces, or 
% * http://www.tug.dk/FontCatalogue/ for a full list of available font packages
...
\titleformat{\chapter}[hang]{\Huge\bfseries}{\thechapter\enspace\textcolor{BrickRed}{|}\enspace}{0pt}{\Huge\bfseries}
